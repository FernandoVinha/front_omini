...
import 'listade_clientes_model.dart';
export 'listade_clientes_model.dart';

class ListadeClientesWidget extends StatefulWidget {
  const ListadeClientesWidget({super.key});

  static String routeName = 'ListadeClientes';
  static String routePath = '/listadeClientes';

  @override
  State<ListadeClientesWidget> createState() => _ListadeClientesWidgetState();
}

class _ListadeClientesWidgetState extends State<ListadeClientesWidget> {
  late ListadeClientesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListadeClientesModel());
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              context.pushNamed(DashboardComOptionsWidget.routeName);
            },
          ),
          actions: [],
          centerTitle: true,
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                16.0, 0.0, 0.0, 0.0),
                            child: Text(
                              'Abaixo está a lista de clientes cadastrados',
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                                    font: GoogleFonts.inter(
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                labelText: 'Procurar em todos os clientes...',
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: FlutterFlowChoiceChips(
                                    options: [
                                      ChipData('Todos'),
                                      ChipData('Com armadilha'),
                                      ChipData('Sem armadilha')
                                    ],
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'Média de consumo: 48% || Nenhuma ação pendente',
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                                                    .override(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'Média de consumo: 89% || 4 placas precisam ser trocadas',
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                                                    .override(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'Média de consumo: 67% || 1 placa precisa ser trocada',
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                                                    .override(
